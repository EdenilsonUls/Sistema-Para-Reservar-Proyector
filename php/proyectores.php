    ...
    foreach($model as $row)
    {
        //mensaje para verificar si realmente desea borrar o no
                                ...
                                echo '<td width=20% style="text-align:center;">
                                        <a class="btn btn-success" href="../editar/editar-departamento.php?id='.$row['iddepartamento'].'" title="Editar Informaci&oacute;n"><span class="glyphicon glyphicon-pencil"></span> </a>
